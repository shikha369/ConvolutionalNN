...
def visualize(image, conv_output, conv_grad, gb_viz):
    ...
    output = conv_output[0]          # [6,6,256]
    print (output)
    grads_val = conv_grad[0]        # [6,6,256]
    #print (grads_val)
    ...
    #print (weights)
    cam = np.ones(output.shape[0 : 2], dtype = np.float32)	# [6,6]
    #print (cam) #all ones
...
'''
    ...
    ax.set_title('Maximally excited')
